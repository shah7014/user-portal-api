package com.learningbybuilding.supportportal.constant;

public class FileConstants {
    public static final String USER_IMAGE_PATH = "/user/image/";
    public static final String JPG_EXTENSION = "jpg";
    public static final String USER_FOLDER = System.getProperty("user.home") + "/Downloads/support-portal/user/";
